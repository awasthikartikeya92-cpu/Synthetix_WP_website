    ...
    <div class="container">
        <div class="banner-content-area">
            <h1 class="section-title text-normal wow scaleIn" data-wow-delay=".7s">
            	<?php
            if ( is_day() ) :
                esc_html_e( 'Daily Archives: ', 'agenio' );
            
            elseif ( is_month() ) :
                esc_html_e( 'Monthly Archives: ', 'agenio' );
            
            
            elseif ( is_year() ) :
                esc_html_e( 'Yearly Archives: ', 'agenio' );
         ...
         ?>
            ...
            <div class="breadcrumbs effectFade fadeUp">
            	...
            	<div><?php echo esc_html__( 'Archives', 'agenio' ); ?></div>
        	</div>
            <div class="bg-shape">
